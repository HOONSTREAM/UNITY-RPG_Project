...
/// 보석상 케일 상점 스크립트 입니다.
/// </summary>
public class NPC2_shop : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        slots = slotHolder.GetComponentsInChildren<NPC2_shopslot>();
        ...
        {
            slots[0].shopitem = shopitemDB["Head_Decoration"][0];
            slots[1].shopitem = shopitemDB["Head_Decoration"][1];
            ...
            for (int i = 0; i < slots.Length; i++)
            {
                switch (slots[i].slotnum) // 각 슬롯별 구매 갯수 인식
                {
                    ...
                    case 0:
                        ...
                        {
                            PlayerInventory.Instance.AddItem(shopitemDB["Head_Decoration"][0].Clone());
                    ...
                    case 1:
                        ...
                        {
                            PlayerInventory.Instance.AddItem(shopitemDB["Head_Decoration"][1].Clone());
                    ...
                    case 2:
                        ...
                        {
                            PlayerInventory.Instance.AddItem(shopitemDB["Necklace"][0].Clone());
                    ...
                    case 3:
                        ...
                        {
                            PlayerInventory.Instance.AddItem(shopitemDB["Necklace"][1].Clone());
