...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        TalkData.Add(Helken_NPC_ID, new string[] { "안녕, 나는 기사 헬켄이야.", "나에게 볼 일이 있어?" });
    }
    ...
    public void Additional_Talk_Helken()
    {
        ...
        TalkData.Add(Helken_NPC_ID, new string[] {"처음 보는 모험가가 왔군. 반가워. 나는 기사 케넨이라고 해. 루덴시아에는 전설이 하나 전해져내려온다더군. 마을 촌장을 찾아가봐.", 
