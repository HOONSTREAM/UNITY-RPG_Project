...
public class Gold_WithDraw_Console : MonoBehaviour
{
    ...
    public void gold_withdraw()
    {
        ...
        {
            Print_Info_Text.Instance.PrintUserText("찾고자 하는 골드가 맡겨져 있는 골드보다 많습니다.");
        ...
        Print_Info_Text.Instance.PrintUserText($"{inputamount}골드를 찾아 현재 소지중인 골드는 {stat.Gold} 골드 입니다. ");
